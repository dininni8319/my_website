...
document.addEventListener('scroll', function () {
  ...
  if (scrolled > 30) {
    ...
    nav.style.background = 'linear-gradient(0deg, rgba(159,159,150,0.018644957983193322) 10%, rgba(255,255,255,0.938813025210084) 16%, rgba(246,245,242,0.639093137254902) 63%)';
  } else {
...
/* harmony import */ var _timeline2_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./timeline2.js */ "./resources/js/timeline2.js");

var line = document.querySelector(".timeline-innerline");
var timeline_events = document.querySelectorAll(".li-timeline");
var observer = new IntersectionObserver(function (entries, observer) {
  entries.forEach(function (entry) {
    if (entry.isIntersecting) {
      timeline_events.forEach(function (e) {
        (0,_timeline2_js__WEBPACK_IMPORTED_MODULE_0__.showTime)(e);
      });
      line.style.width = "100%";
    }
  });
}, {});
var target = document.querySelector('.timeline ul');
observer.observe(target);
timeline_events.forEach(function (li, index) {
  li.addEventListener('click', function () {
    if (li.getAttribute("done")) {
      line.style.width = "".concat(index / timeline_events.length * 100, "%");
      timeline_events.forEach(function (ev, idx) {
        if (idx >= index) {
          (0,_timeline2_js__WEBPACK_IMPORTED_MODULE_0__.hideTime)(ev);
        }
      });
    } else {
      line.style.width = "".concat((index + 1) / timeline_events.length * 100, "%");
      timeline_events.forEach(function (ev, idx) {
        if (idx <= index) {
          (0,_timeline2_js__WEBPACK_IMPORTED_MODULE_0__.showTime)(ev);
        }
      });
    }
...
/* harmony export */   "hideTime": () => (/* binding */ hideTime)
/* harmony export */ });
function showTime(e) {
